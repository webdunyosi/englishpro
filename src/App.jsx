              ...
              <div className="w-full max-w-xl glass-card rounded-2xl p-4 border-l-4 border-rose-500 bg-rose-500/5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                    <span className="text-gray-900 dark:text-white font-medium">ESLATMA:</span> Ko'p dars qoldiradigan va vazifalarni o'z vaqtida bajarmaydigan o'quvchilar darslardan chetlashtiriladi! Natija faqat mehnat va mas'uliyat bilan keladi.
                  </p>
                </div>
              </div>
